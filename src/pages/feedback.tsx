        ...
        <Card
          ...
          <Typography>
            <Title style={{ textAlign: "center" }}>
              <Translate
                id='feedback.welcome'
                description='The welcome title on the feedback page'>
                欢迎给出反馈
              </Translate>
            </Title>
            <Paragraph>
              <Translate
                ...
                description='The main paragraph on the feedback page'>
                欢迎给出建议、想法和提示词，以便不断改进 ChatGPT
                Shortcut，并提高个人效率和生产力。如果您需要反馈
