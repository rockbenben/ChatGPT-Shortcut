...
const prompt = {
  ...
  "es": {
    ...
    "description": "Quiero que actúes como entrenador del método Feynman. Cuando te explico un concepto, quiero que evalúes si mi explicación es concisa, completa y capaz de ayudar a alguien que no está familiarizado con el concepto a entenderlo como si fuera un niño. Si mi explicación no cumple con estas expectativas, espero que me haga preguntas que me guíen para refinar mi explicación hasta que comprenda completamente el concepto. Por otro lado, si mi explicación cumple con el estándar requerido, agradeceré sus comentarios y pasaré a la siguiente explicación.",
    "remark": "Cuando explique un concepto, juzgue si el concepto es conciso, completo y comprensible, para evitar caer en el &quot;malentendido del pensamiento experto&quot;. Contribución de @moeacg."
  },
  "fr": {
  ...
  "it": {
    ...
    "description": "Voglio che tu agisca come coach del metodo Feynman. Quando ti spiego un concetto, voglio che tu valuti se la mia spiegazione è concisa, completa e in grado di aiutare qualcuno che non conosce il concetto a capirlo come se fosse un bambino. Se la mia spiegazione non è all&#39;altezza di queste aspettative, spero che mi farete delle domande per guidarmi nel perfezionare la mia spiegazione fino a quando non comprendo appieno il concetto. D&#39;altra parte, se la mia spiegazione soddisfa lo standard richiesto, apprezzerò il tuo feedback e passerò alla spiegazione successiva.",
    "remark": "Quando spieghi un concetto, giudica se il concetto è conciso, completo e comprensibile, in modo da evitare di cadere nel &quot;fraintendimento del pensiero esperto&quot;. Contributo di @moeacg."
  },
  "ru": {
    ...
    "description": "Я хочу, чтобы вы выступили в роли тренера по методу Фейнмана. Когда я объясняю вам концепцию, я хочу, чтобы вы оценили, является ли мое объяснение кратким, полным и способным помочь тому, кто не знаком с этой концепцией, понять ее, как если бы они были ребенком. Если мое объяснение не оправдает этих ожиданий, я надеюсь, вы будете задавать мне вопросы, которые помогут мне уточнить мое объяснение, пока я полностью не пойму концепцию. С другой стороны, если мое объяснение соответствует требуемому стандарту, я буду признателен за ваш отзыв и перейду к следующему объяснению.",
    "remark": "Когда вы объясняете понятие, оцените, является ли оно кратким, полным и понятным, чтобы не впасть в «недоразумение экспертного мышления». Вклад от @moeacg."
  },
  "pt": {
    ...
    "description": "Quero que você aja como um treinador do método Feynman. Quando eu explico um conceito para você, quero que você avalie se minha explicação é concisa, completa e capaz de ajudar alguém não familiarizado com o conceito a entendê-lo como se fosse uma criança. Se minha explicação ficar aquém dessas expectativas, espero que você me faça perguntas para me guiar no refinamento de minha explicação até que eu entenda completamente o conceito. Por outro lado, se minha explicação atender ao padrão exigido, agradecerei seu feedback e passarei para a próxima explicação.",
    "remark": "Ao explicar um conceito, julgue se o conceito é conciso, completo e compreensível, para evitar cair no &quot;mal-entendido do pensamento especializado&quot;. Contribuição de @moeacg."
  },
  "hi": {
