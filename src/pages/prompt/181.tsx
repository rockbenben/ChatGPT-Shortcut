...
const prompt = {
  ...
  "ja": {
    "title": "日本語→英語翻訳 - ミニマム版",
    "prompt": "The entire conversation and instructions should be provided in Japanese. ja-en translation of \"X\".",
    "description": "X の部分は日本語でも英語でもよく、chatgpt は自動的にそれぞれの言語に翻訳します。まっすぐな二重引用符（\"）を使用することが最もうまくいくことがテストされています。api コールを使用するときに役割のためにアシスタントを選択すると、翻訳されるテキストがコマンドとして解釈される（避けられない）確率を減らすことができます。",
    "remark": "API で構築された翻訳プラットフォーム ChatGPT のためのトークン節約型翻訳者プロンプトです。寄稿者：@Qizhen-Yang。"
  },
  "ko": {
    "title": "중국어에서 영어로 번역 - 미니멀리스트 버전",
    "prompt": "The entire conversation and instructions should be provided in Korean. ko-en translation of \"X\".",
  ...
  "es": {
    ...
    "prompt": "The entire conversation and instructions should be provided in Spanish. es-en translation of \"X\".",
  ...
  "fr": {
    ...
    "prompt": "The entire conversation and instructions should be provided in French. fr-en translation of \"X\".",
  ...
  "de": {
    ...
    "prompt": "The entire conversation and instructions should be provided in German. de-en translation of \"X\".",
  ...
  "it": {
    ...
    "prompt": "The entire conversation and instructions should be provided in Italian. it-en translation of \"X\".",
  ...
  "ru": {
    ...
    "prompt": "The entire conversation and instructions should be provided in Russian. ru-en translation of \"X\".",
  ...
  "pt": {
    ...
    "prompt": "The entire conversation and instructions should be provided in Portuguese. pt-en translation of \"X\".",
  ...
  "hi": {
    ...
    "prompt": "The entire conversation and instructions should be provided in Hindi. hi-en translation of \"X\".",
  ...
  "ar": {
    ...
    "prompt": "The entire conversation and instructions should be provided in Arabic. ar-en translation of \"X\".",
  ...
  "bn": {
    ...
    "prompt": "The entire conversation and instructions should be provided in Bengali. bn-en translation of \"X\".",
