...
- **Firefox**: [Firefox Browser ADD-ONS](https://addons.mozilla.org/addon/chatgpt-shortcut/)（装完需做一次[授权设置](./firefox-extension-setting.md)，否则在 ChatGPT 上不显示侧边栏）
...
> 📖 安装教程：[CRX 文件](./manual-chrome-extension.md) · [ZIP 文件](./manual-chrome-extension-zip.md)

## ✅ 装好后

按 `Alt + Shift + S` 唤出，或点击工具栏图标。详细用法见[使用教程](./usage.md)。
