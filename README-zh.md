...
<p align="center">
    <em>上千条经过打磨的 AI 提示词库——让 ChatGPT、Cursor 等任意 AI 工具的输出从平庸变专业。</em>
</p>
...
<table>
  <tr>
    <td width="50%"><img src="static/img/docs/my-collection-view.gif" alt="我的收藏" /></td>
    <td width="50%"><img src="static/img/docs/extension-sidebar.gif" alt="浏览器扩展" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="50%"><img src="static/img/docs/prompt-card.gif" alt="提示词卡片" /></td>
    <td width="50%"><img src="static/img/docs/community-page.png" alt="社区" /></td>
  </tr>
  <tr>
...
> **提示**：Vercel 一键部署会创建新项目（而非 fork），导致上游更新检测失效。要获得自动同步，请先 fork 仓库，再在 Vercel 导入 fork。详细步骤见[部署指南](https://www.aishort.top/docs/deploy#开启同步更新)。
