...
import favorDefault from "@site/src/data/default/favor_ja.json";
import otherDefault from "@site/src/data/default/other_ja.json";
...
function ShowcaseCards({ isDescription, showUserFavs }) {
  ...
  const allIds = [
    ...
    32, 249, 174, 104, 113, 225, 227, 105, 33, 156, 34, 277, 127, 268, 275, 273, 274, 272, 276, 110, 230, 231, 278,
  ];
