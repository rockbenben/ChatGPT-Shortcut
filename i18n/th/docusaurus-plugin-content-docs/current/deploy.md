...
## การติดตั้งแบบออฟไลน์ (อินทราเน็ตองค์กร)

หากคุณต้องการติดตั้งในอินทราเน็ตองค์กรหรือเครือข่ายราชการที่ไม่สามารถเข้าถึงเครือข่ายภายนอกได้ AI Short มีเวอร์ชันออฟไลน์โดยเฉพาะ ไม่ต้องใช้เซิร์ฟเวอร์ backend หรือการลงทะเบียน ข้อมูลทั้งหมดเก็บในเบราว์เซอร์

ติดตั้งเวอร์ชันออฟไลน์ด้วย Docker คำสั่งเดียว:

```bash
docker run -d -p 3000:3000 --name aishort-offline ghcr.io/rockbenben/chatgpt-shortcut:offline
```

ดูคู่มือรายละเอียดและตัวเลือกการกำหนดค่าที่ [คู่มือการติดตั้งแบบออฟไลน์](./guides/offline)
