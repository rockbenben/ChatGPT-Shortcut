...
> 📖 คู่มือการติดตั้ง: [ไฟล์ CRX](./manual-chrome-extension) · [ไฟล์ ZIP](./manual-chrome-extension-zip)

## หลังติดตั้งเสร็จ

กด `Alt + Shift + S` เพื่อเรียกใช้ หรือคลิกไอคอนบนแถบเครื่องมือ ดูรายละเอียดที่[คู่มือการใช้งาน](./usage)
