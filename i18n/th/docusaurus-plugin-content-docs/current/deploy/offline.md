...
![สถาปัตยกรรมข้อมูลของเวอร์ชันออฟไลน์: เซิร์ฟเวอร์อินทราเน็ตเครื่องเดียวให้บริการคลัง prompt ที่ใช้ร่วมกันแบบอ่านอย่างเดียว ส่วนคอลเลกชัน, prompt, ลำดับ และแท็กของผู้ใช้แต่ละคนเก็บไว้ใน localStorage ของเบราว์เซอร์ตนเอง แยกจากกันโดยอิสระ ไม่ต้องมีบัญชี](/img/docs/offline-architecture.svg)
