...
4. O navegador não permite a instalação de arquivos crx? Tente instalar o arquivo zip! [Clique aqui para ver o tutorial de instalação zip](./manual-chrome-extension-zip).
