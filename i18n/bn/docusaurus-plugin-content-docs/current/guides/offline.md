...
```
ইন্ট্রানেট সার্ভার (অফলাইন সংস্করণ স্থাপিত)
   ├── প্রম্পট লাইব্রেরির ডেটা (সবার জন্য শেয়ার্ড, স্ট্যাটিক JSON থেকে)
   │
   ├── ব্যবহারকারী A-এর ব্রাউজার → localStorage (A-এর সংগ্রহ ও কাস্টম প্রম্পট)
   ├── ব্যবহারকারী B-এর ব্রাউজার → localStorage (B-এর সংগ্রহ ও কাস্টম প্রম্পট)
   └── ব্যবহারকারী C-এর ব্রাউজার → localStorage (C-এর সংগ্রহ ও কাস্টম প্রম্পট)
```
...
- ব্রাউজার ডেটা মুছে ফেললে ব্যক্তিগত ডেটা হারিয়ে যাবে — নিয়মিত "সেটিংস > ডেটা এক্সপোর্ট" এর মাধ্যমে ব্যাকআপ নেওয়ার পরামর্শ দেওয়া হচ্ছে।
...
"সেটিংস > ডেটা এক্সপোর্ট" এ প্রবেশ করুন, ব্যক্তিগত সংগ্রহ ও কাস্টম প্রম্পট JSON ফাইল হিসেবে এক্সপোর্ট করুন।
...
২. অফলাইন সংস্করণের "সেটিংস" পৃষ্ঠায় সেই JSON ফাইলটি ইম্পোর্ট করুন
...
গুরুত্বপূর্ণ ডেটা নিয়মিতভাবে "সেটিংস > ডেটা এক্সপোর্ট" এর মাধ্যমে JSON ফাইল হিসেবে ব্যাকআপ নেওয়ার পরামর্শ দেওয়া হচ্ছে।

### দলের মধ্যে কাস্টম প্রম্পট শেয়ার করা যাবে কি?

হ্যাঁ, যাবে। একজন JSON ফাইল এক্সপোর্ট করার পরে, অন্যান্য সদস্যরা "সেটিংস > ডেটা ইম্পোর্ট" এ ইম্পোর্ট করতে পারবেন, স্বয়ংক্রিয়ভাবে ডুপ্লিকেট অপসারণ হবে।
