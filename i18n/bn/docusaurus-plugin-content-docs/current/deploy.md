...
## অফলাইন ডিপ্লয়মেন্ট (এন্টারপ্রাইজ ইন্ট্রানেট)

আপনার যদি বাহ্যিক নেটওয়ার্ক অ্যাক্সেস ছাড়া এন্টারপ্রাইজ ইন্ট্রানেট বা সরকারি নেটওয়ার্কে ডিপ্লয় করার প্রয়োজন হয়, AI Short একটি উত্সর্গীকৃত অফলাইন সংস্করণ প্রদান করে। কোনো ব্যাকএন্ড সার্ভার বা নিবন্ধনের প্রয়োজন নেই, সমস্ত ডেটা ব্রাউজারে স্থানীয়ভাবে সংরক্ষিত হয়।

Docker দিয়ে একটি কমান্ডে অফলাইন সংস্করণ ডিপ্লয় করুন:

```bash
docker run -d -p 3000:3000 --name aishort-offline ghcr.io/rockbenben/chatgpt-shortcut:offline
```

বিস্তারিত গাইড এবং কনফিগারেশন বিকল্পের জন্য [অফলাইন ডিপ্লয়মেন্ট গাইড](./guides/offline) দেখুন।
