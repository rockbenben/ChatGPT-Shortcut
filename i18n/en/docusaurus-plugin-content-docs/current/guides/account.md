...
AiShort works without an account — but **logging in** lets you collect your favorite prompts, create your own, share them to the community, and sync across devices. This page covers login, registration, passwords, and data.
...
Click the Google button in the login dialog for one-click sign-in. The first time you do this, we create an account for you automatically — no separate registration step.
...
Click the edit icon next to your username, then save.
...
The account page shows your **level (L0–L9)** and progress to the next tier — your level is determined by **how many prompts you've shared to the community**.
