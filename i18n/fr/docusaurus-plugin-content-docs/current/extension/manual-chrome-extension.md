...
4. Le navigateur n'autorise pas l'installation de fichiers crx ? Essayez d'installer le fichier zip ! [Cliquez ici pour voir le tutoriel d'installation ZIP](./manual-chrome-extension-zip).
