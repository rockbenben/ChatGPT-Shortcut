...
- **Firefox**: [Firefox Browser ADD-ONS](https://addons.mozilla.org/addon/chatgpt-shortcut/)（裝完需做一次[授權設置](./firefox-extension-setting.md)，否則在 ChatGPT 上不顯示側邊欄）
...
> 📖 安裝教程：[CRX 文件](./manual-chrome-extension.md) · [ZIP 文件](./manual-chrome-extension-zip.md)

## ✅ 裝好後

按 `Alt + Shift + S` 喚出，或點擊工具欄圖標。詳細用法見[使用教程](./usage.md)。
