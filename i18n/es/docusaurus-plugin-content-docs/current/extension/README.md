...
- **Firefox**: [Firefox Browser ADD-ONS](https://addons.mozilla.org/addon/chatgpt-shortcut/) (después de instalar necesitas hacer una [configuración de permisos](./firefox-extension-setting.md), o la barra lateral no aparecerá en ChatGPT)
...
> 📖 Guías de instalación: [Archivo CRX](./manual-chrome-extension.md) · [Archivo ZIP](./manual-chrome-extension-zip.md)

## ✅ Después de instalar

Presiona `Alt + Shift + S` para invocar, o haz clic en el icono de la barra de herramientas. Para más detalles, consulta la [guía de uso](./usage.md).
